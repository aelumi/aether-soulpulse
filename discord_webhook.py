...
DISCORD_WEBHOOK_URL = os.getenv("DISCORD_WEBHOOK_URL")  # Set in environment or .env file
DISCORD_BOT_TOKEN = os.getenv("DISCORD_BOT_TOKEN")
DISCORD_CHANNEL_ID = int(os.getenv("DISCORD_CHANNEL_ID", 0))  # Numeric ID of channel
...
if __name__ == "__main__":
    ...
    print("[Aether] Scan complete. Logs updated.")
